        ...
        <Card className="border-border/40 backdrop-blur-sm bg-card/50">
          ...
          <CardContent>
            {hasCompletedKYC ? (
              ...
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground ivy-font">
                  Complete your organization profile to unlock full access to ARGUS features including threat analytics, module configuration, and AI-powered security assistance.
                </p>
                <Button
                  onClick={() => router.push("/dashboard")}
