          ...
          <div className="order-2 flex flex-col items-start md:order-1">
            <div className="mb-4 sm:mb-6 flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400">AI Safety and Chatbot Security</div>
              </div>
            </div>
            <span className="mb-3 sm:mb-4 inline-flex items-center rounded-full border border-emerald-500/20 bg-emerald-500/20 backdrop-blur-sm px-2.5 sm:px-3 py-1 text-xs font-medium text-emerald-700 dark:text-emerald-300 dark:bg-emerald-500/10">
              AI-Powered Prompt Injection Monitoring Platform
            </span>
            <h1 className="mb-3 sm:mb-4 text-3xl sm:text-4xl font-bold tracking-tight text-slate-900 dark:text-white lg:text-5xl xl:text-6xl">
              Protect chatbot workflows with
            ...
            <p className="mb-6 sm:mb-8 max-w-xl text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-300">
              Detect and score suspicious prompts before model execution. Monitor malicious behavior, enforce safe responses, and maintain a clear security audit trail.
            </p>
          ...
          <div className="order-1 md:order-2 w-full relative">
            ...
            <div className="absolute -top-4 -right-4 sm:top-8 sm:right-8 z-20 animate-float">
              <div className="flex items-center gap-3 bg-linear-to-r from-emerald-500/90 to-teal-500/90 backdrop-blur-md rounded-full px-4 py-3 shadow-xl border border-emerald-400/30">
                ...
                <div className="text-left">
                  ...
                  <p className="text-white/80 text-xs ivy-font">Live Detection Metrics</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -left-4 sm:bottom-12 sm:left-4 z-20 animate-float-delayed">
              <div className="flex items-center gap-3 bg-linear-to-r from-blue-500/90 to-cyan-500/90 backdrop-blur-md rounded-full px-4 py-3 shadow-xl border border-blue-400/30">
                ...
                <div className="text-left">
                  <p className="text-white font-semibold text-sm ivy-font">Policy Enforcement</p>
                  <p className="text-white/80 text-xs ivy-font">Actionable Risk Scoring</p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">
              ...
              <span className="block mt-2 bg-linear-to-r from-emerald-500 via-teal-400 to-cyan-400 bg-clip-text text-transparent">
                Production-Grade AI Safety Monitoring
              </span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Real-time prompt-injection detection, reliable enforcement controls, and professional operational visibility for security teams
            </p>
          </div>
            ...
            <div className="relative z-10 p-8 sm:p-12 lg:p-16">
              <div className="max-w-xl">
                ...
                <h3 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4">
                  Contextual Threat Intelligence Engine
                </h3>
                <p className="text-lg text-slate-700 dark:text-slate-200 mb-6">
                  Maintains deep context awareness across user interactions, automatically tracking suspicious patterns, indicators, and policy decisions in real time.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardTitle className="text-xl ivy-font">Knowledge Graph Security Memory</CardTitle>
                <CardDescription className="ivy-font">
                  Dynamic knowledge graph tracks suspicious entities and relationships so investigators can quickly map behavior patterns and risk context
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardDescription className="ivy-font">
                  Ask natural language questions about incidents and receive precise operational summaries with relevant context
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardDescription className="ivy-font">
                  Compatible with private chats and shared rooms, with consistent scoring and enforcement across user workflows
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-border/40 backdrop-blur-sm bg-card/50 cursor-pointer">
              <CardHeader>
                ...
                <CardDescription className="ivy-font">
                  Shared security visibility for teams with role-based access and a centralized evidence trail
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
